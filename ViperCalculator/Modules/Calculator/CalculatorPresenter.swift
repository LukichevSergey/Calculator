...
class CalculatorPresenter {
    ...
    static let shared = CalculatorPresenter()
    ...
    private func pressToResult() {
        ...
        self.numberTwo = secondNumber
        calculateResult()
        Operations.shared.saveOperation(firstNumber: self.numberOne, secondNumber: self.numberTwo, sign: self.sign.rawValue, result: self.resultText)
        self.sign      = .empty
        self.numberOne = 0
    }
