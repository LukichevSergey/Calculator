...
//  ViperCalculator
//
//  Created by Сергей Лукичев on 20.11.2021.
//
...
class CalculatorProperties {
    ...
    private func calculateResult() {
        ...
        Operations.shared.saveOperation(firstNumber: numberOne, secondNumber: numberTwo, sign: sign.rawValue, result: resultText)
    }
